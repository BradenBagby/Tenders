...
abstract class $RoomCopyWith<$Res> {
  ...
  $Res call(
      {String id, DateTime createdAt, RoomSettings settings, bool started});
...
class _$_Room implements _Room {
  ...
  @override
  String toString() {
    return 'Room(id: $id, createdAt: $createdAt, settings: $settings, started: $started)';
  }
