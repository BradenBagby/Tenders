...
mixin _$RoomState {
  ...
  List<Restauraunt> get restauraunts =>
...
class _$_RoomState implements _RoomState {
  ...
  @override
  String toString() {
    return 'RoomState(room: $room, me: $me, members: $members, currentLocation: $currentLocation, restauraunts: $restauraunts, closed: $closed)';
  }
